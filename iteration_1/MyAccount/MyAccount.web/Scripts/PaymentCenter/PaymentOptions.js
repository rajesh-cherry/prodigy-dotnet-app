...
$(document).ready(function () {
    ...
    var testgexalink = PaymentUIIFrameUrl + "autobillpay?Brand=" + BrandCode;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.resultCode == 1) {
                            ...
                            document.getElementById('PaymentOptionsAutoPayIFrame').src = testgexalink;
    ...
    var iframe = document.querySelector('#PaymentOptionsAutoPayIFrame');
    ...
    $('#PaymentOptionsAutoPayIFrame').on('load', function () {// Here's how you'd do this with jQuery
    });
    ...
    function iframePostHandler(evt) {
        if (evt && evt.data) {
            var paymentAccountsIframe = $('#PaymentOptionsAutoPayIFrame')[0];
