...
$(document).ready(function () {
    ...
    var testgexalink = PaymentUIIFrameUrl + "MakePayment?Brand=" + BrandCode;
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.resultCode == 1) {
                            ...
                            document.getElementById('MakePaymentIFrame').src = testgexalink;
    ...
    var iframe = document.querySelector('#MakePaymentIFrame');
    ...
    $('#MakePaymentIFrame').on('load', function () {// Here's how you'd do this with jQuery
    });
    ...
    function iframePostHandler(evt) {
        if (evt && evt.data) {
            var paymentAccountsIframe = $('#MakePaymentIFrame')[0];
            ...
            if (evt.data.INSERTPCI) {
                ...
                var request = {
                    ...
                    //Url: "".concat("http://localhost:27570/Payment/ValidatePCITransactionLog"),
